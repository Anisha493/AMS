...
>>>>>>> 2fda68d40d5cff0d7e7989cdff653a061fd19466
      ...
      <div ref={aboutRef} className="bg-gray-100 py-16 px-4 text-center">
        ...
        <p className="text-gray-700 text-lg max-w-8xl mx-auto mb-1">
          Student Connect Nepal is committed to providing cutting-edge digital solutions focused on improving attendance tracking and educational analysis. This Attendance Monitoring System allows schools and colleges to effectively track students attendance using modern digital tools. Student Connect Nepal is built on a committed community of members working in development, teaching, and design who come together to turn visits to schools into smooth digital experiences.</p>
...
>>>>>>> 2fda68d40d5cff0d7e7989cdff653a061fd19466
      ...
      {/* Contact Section */}
      <div ref={contactRef} className="bg-gray-100 py-16 px-4"> DDxx 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="text-left">
              ...
              <div className="space-y-3">
                ...
                <p className="text-gray-700">
                  <span className="font-semibold">Phone:</span> +977-9814567890, +977-9823456701
                </p>
                <p className="text-gray-700">
